...
public class CustomListViewBerandaPetani extends BaseAdapter {
    ...
    public CustomListViewBerandaPetani(Context context, List<Artikel> fData) {
        this.fData = fData;
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        view = layoutInflater.inflate(R.layout.activity_custom_list_view_beranda_petani, viewGroup,false);
        ...
        bgCopy.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent in = new Intent(context, ArtikelActivity.class);
